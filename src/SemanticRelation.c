...
/**
 * Frees memory allocated for a semantic relation.
 * @param semantic_relation Semantic relation to be deallocated.
 */
...
/**
 * Comparator method to compare two semantic relations based on their names.
 * @param relation1 First semantic relation to compare
 * @param relation2 Second semantic relation to compare
 * @return -1 if the name of the first semantic relation comes first lexicographically, 1 if the name of the second
 * semantic relation comes first lexicographically, 0 otherwise.
 */
 ...
 *
 * @param name         name of the relation
 * @param relation_type semantic dependency tag
 */
